...
(function () {
    ...
    function setupImageFallback(img, labelText) {
        ...
        img.addEventListener('error', function () {
            ...
            if (parent) {
                ...
                fallback.textContent = labelText || 'Our Memory ✦';
    ...
    /* -----------------------------------------------------------------
       04 — OUR MEMORIES (Gallery + Lightbox)
    ----------------------------------------------------------------- */
    ...
    /* -----------------------------------------------------------------
       06 — HOW WELL DO YOU KNOW US? (Quiz)
    ----------------------------------------------------------------- */
    function initQuiz() {
        ...
        function renderResult() {
            ...
            quizBox.innerHTML = `
                <div class="quiz-result">
                    ...
                    <button class="quiz-retry" id="quizRetry" type="button">Play Again ↺</button>
                </div>
            `;
    ...
    /* -----------------------------------------------------------------
       07 — OUR LITTLE THINGS (Notes Desk)
    ----------------------------------------------------------------- */
    function initNotes() {
    ...
    /* -----------------------------------------------------------------
       08 — THE LETTER & 09 — ONE LAST THING
    ----------------------------------------------------------------- */
